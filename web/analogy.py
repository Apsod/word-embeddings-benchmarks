...
def wordrep2analogy(X_cat):
    ...
    for ix, (left, right) in enumerate(itertools.permutations(X_cat, r=2)):
        X[ix, 0:2] = left
        X[ix, 2] = right[0]
        y[ix] = right[1]
    return X, y

class AnalogySolver(object):
    def __init__(self, analogy, batch_size=300):
